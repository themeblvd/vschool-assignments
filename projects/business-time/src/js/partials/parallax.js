 ...
 * banners.
 */
var imageElement    = document.querySelector( '.hero-bg img' ),
    heroElementWrap = document.querySelector( '.section-home-hero .wrap' );

window.addEventListener( 'scroll', function applyParallax() {

    var intensity = 8, // Use number between 5-10
    ...
    if ( heroElementWrap ) {
        ...
        let distance = scrollPos / heroElementWrap.offsetTop,
            opacity  = distance + 1 - (distance * 2); // distance => opacity, .1 => .9, .2 => .8, .3 => .7, etc.
